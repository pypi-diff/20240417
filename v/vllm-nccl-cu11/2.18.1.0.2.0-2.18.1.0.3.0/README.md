# Comparing `tmp/vllm_nccl_cu11-2.18.1.0.2.0.tar.gz` & `tmp/vllm_nccl_cu11-2.18.1.0.3.0.tar.gz`
...
+gzip compressed data, was "vllm_nccl_cu11-2.18.1.0.3.0.tar", last modified: Wed Apr 17 04:54:43 2024, max compression
```

## Comparing `vllm_nccl_cu11-2.18.1.0.2.0.tar` & `vllm_nccl_cu11-2.18.1.0.3.0.tar`
...
+drwxr-xr-x   0 youkaichao   (501) staff       (20)        0 2024-04-17 04:54:43.044869 vllm_nccl_cu11-2.18.1.0.3.0/
+-rw-r--r--   0 youkaichao   (501) staff       (20)    11357 2024-04-02 16:28:30.000000 vllm_nccl_cu11-2.18.1.0.3.0/LICENSE
+-rw-r--r--   0 youkaichao   (501) staff       (20)       87 2024-04-17 04:54:43.044632 vllm_nccl_cu11-2.18.1.0.3.0/PKG-INFO
+-rw-r--r--   0 youkaichao   (501) staff       (20)      164 2024-04-03 20:59:04.000000 vllm_nccl_cu11-2.18.1.0.3.0/README.md
+-rw-r--r--   0 youkaichao   (501) staff       (20)       38 2024-04-17 04:54:43.044913 vllm_nccl_cu11-2.18.1.0.3.0/setup.cfg
+-rw-r--r--   0 youkaichao   (501) staff       (20)     3417 2024-04-17 04:48:38.000000 vllm_nccl_cu11-2.18.1.0.3.0/setup.py
+drwxr-xr-x   0 youkaichao   (501) staff       (20)        0 2024-04-17 04:54:43.043971 vllm_nccl_cu11-2.18.1.0.3.0/vllm_nccl/
+-rw-r--r--   0 youkaichao   (501) staff       (20)        0 2024-04-02 17:29:00.000000 vllm_nccl_cu11-2.18.1.0.3.0/vllm_nccl/__init__.py
+drwxr-xr-x   0 youkaichao   (501) staff       (20)        0 2024-04-17 04:54:43.044458 vllm_nccl_cu11-2.18.1.0.3.0/vllm_nccl_cu11.egg-info/
+-rw-r--r--   0 youkaichao   (501) staff       (20)       87 2024-04-17 04:54:42.000000 vllm_nccl_cu11-2.18.1.0.3.0/vllm_nccl_cu11.egg-info/PKG-INFO
+-rw-r--r--   0 youkaichao   (501) staff       (20)      200 2024-04-17 04:54:42.000000 vllm_nccl_cu11-2.18.1.0.3.0/vllm_nccl_cu11.egg-info/SOURCES.txt
+-rw-r--r--   0 youkaichao   (501) staff       (20)        1 2024-04-17 04:54:42.000000 vllm_nccl_cu11-2.18.1.0.3.0/vllm_nccl_cu11.egg-info/dependency_links.txt
+-rw-r--r--   0 youkaichao   (501) staff       (20)       10 2024-04-17 04:54:42.000000 vllm_nccl_cu11-2.18.1.0.3.0/vllm_nccl_cu11.egg-info/top_level.txt
```

### Comparing `vllm_nccl_cu11-2.18.1.0.2.0/LICENSE` & `vllm_nccl_cu11-2.18.1.0.3.0/LICENSE`

 * *Files identical despite different names*

### Comparing `vllm_nccl_cu11-2.18.1.0.2.0/setup.py` & `vllm_nccl_cu11-2.18.1.0.3.0/setup.py`
