# Comparing `tmp/sound_scape_explorer-13.2.0.tar.gz` & `tmp/sound_scape_explorer-13.2.1.tar.gz`
...
### Comparing `sound_scape_explorer-13.2.0/PKG-INFO` & `sound_scape_explorer-13.2.1/PKG-INFO`
...
### Comparing `sound_scape_explorer-13.2.0/processing/actions/export_mdm.py` & `sound_scape_explorer-13.2.1/processing/actions/export_mdm.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/actions/extract_and_aggregate.py` & `sound_scape_explorer-13.2.1/processing/actions/extract_and_aggregate.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/actions/fix_audio_windows_10_7_2.py` & `sound_scape_explorer-13.2.1/processing/actions/fix_audio_windows_10_7_2.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/actions/purge_requirements.py` & `sound_scape_explorer-13.2.1/processing/actions/purge_requirements.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/actions/reduce.py` & `sound_scape_explorer-13.2.1/processing/actions/reduce.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/actions/refresh_configuration.py` & `sound_scape_explorer-13.2.1/processing/actions/refresh_configuration.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/actions/repack_storage.py` & `sound_scape_explorer-13.2.1/processing/actions/repack_storage.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/actions/trace_relative_trajectories.py` & `sound_scape_explorer-13.2.1/processing/actions/trace_relative_trajectories.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/actions/trace_trajectories.py` & `sound_scape_explorer-13.2.1/processing/actions/trace_trajectories.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/cli.py` & `sound_scape_explorer-13.2.1/processing/cli.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/common/AggregatedLabelStorage.py` & `sound_scape_explorer-13.2.1/processing/common/AggregatedLabelStorage.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/common/AggregatedReduceable.py` & `sound_scape_explorer-13.2.1/processing/common/AggregatedReduceable.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/common/AggregatedStorage.py` & `sound_scape_explorer-13.2.1/processing/common/AggregatedStorage.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/common/AutoclusteredStorage.py` & `sound_scape_explorer-13.2.1/processing/common/AutoclusteredStorage.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/common/ComputationUmapStorage.py` & `sound_scape_explorer-13.2.1/processing/common/ComputationUmapStorage.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/common/ContinuousTimeTrajectory.py` & `sound_scape_explorer-13.2.1/processing/common/ContinuousTimeTrajectory.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/common/FileWalker.py` & `sound_scape_explorer-13.2.1/processing/common/FileWalker.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/common/MeanDistancesMatrix.py` & `sound_scape_explorer-13.2.1/processing/common/MeanDistancesMatrix.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/common/MenuChoice.py` & `sound_scape_explorer-13.2.1/processing/common/MenuChoice.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/common/RelativeTracedStorage.py` & `sound_scape_explorer-13.2.1/processing/common/RelativeTracedStorage.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/common/Timeline.py` & `sound_scape_explorer-13.2.1/processing/common/Timeline.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/common/TimelineWalker.py` & `sound_scape_explorer-13.2.1/processing/common/TimelineWalker.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/common/TracedStorage.py` & `sound_scape_explorer-13.2.1/processing/common/TracedStorage.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/Config.py` & `sound_scape_explorer-13.2.1/processing/config/Config.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/ConfigParser.py` & `sound_scape_explorer-13.2.1/processing/config/ConfigParser.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/autoclusters/AutoclusterConfig.py` & `sound_scape_explorer-13.2.1/processing/config/autoclusters/AutoclusterConfig.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/autoclusters/AutoclusterStorage.py` & `sound_scape_explorer-13.2.1/processing/config/autoclusters/AutoclusterStorage.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/bands/BandConfig.py` & `sound_scape_explorer-13.2.1/processing/config/bands/BandConfig.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/bands/BandStorage.py` & `sound_scape_explorer-13.2.1/processing/config/bands/BandStorage.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/binary/BinaryStorage.py` & `sound_scape_explorer-13.2.1/processing/config/binary/BinaryStorage.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/digesters/DigesterConfig.py` & `sound_scape_explorer-13.2.1/processing/config/digesters/DigesterConfig.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/digesters/DigesterStorage.py` & `sound_scape_explorer-13.2.1/processing/config/digesters/DigesterStorage.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/extractors/ExtractorConfig.py` & `sound_scape_explorer-13.2.1/processing/config/extractors/ExtractorConfig.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/extractors/ExtractorStorage.py` & `sound_scape_explorer-13.2.1/processing/config/extractors/ExtractorStorage.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/files/FileConfig.py` & `sound_scape_explorer-13.2.1/processing/config/files/FileConfig.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/files/FileStorage.py` & `sound_scape_explorer-13.2.1/processing/config/files/FileStorage.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/integrations/IntegrationConfig.py` & `sound_scape_explorer-13.2.1/processing/config/integrations/IntegrationConfig.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/integrations/IntegrationStorage.py` & `sound_scape_explorer-13.2.1/processing/config/integrations/IntegrationStorage.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/labels/LabelConfig.py` & `sound_scape_explorer-13.2.1/processing/config/labels/LabelConfig.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/labels/LabelStorage.py` & `sound_scape_explorer-13.2.1/processing/config/labels/LabelStorage.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/ranges/RangeConfig.py` & `sound_scape_explorer-13.2.1/processing/config/ranges/RangeConfig.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/ranges/RangeStorage.py` & `sound_scape_explorer-13.2.1/processing/config/ranges/RangeStorage.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/reducers/ReducerConfig.py` & `sound_scape_explorer-13.2.1/processing/config/reducers/ReducerConfig.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/reducers/ReducerStorage.py` & `sound_scape_explorer-13.2.1/processing/config/reducers/ReducerStorage.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/settings/SettingsStorage.py` & `sound_scape_explorer-13.2.1/processing/config/settings/SettingsStorage.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/sites/SiteConfig.py` & `sound_scape_explorer-13.2.1/processing/config/sites/SiteConfig.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/sites/SiteStorage.py` & `sound_scape_explorer-13.2.1/processing/config/sites/SiteStorage.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/trajectories/TrajectoryConfig.py` & `sound_scape_explorer-13.2.1/processing/config/trajectories/TrajectoryConfig.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/config/trajectories/TrajectoryStorage.py` & `sound_scape_explorer-13.2.1/processing/config/trajectories/TrajectoryStorage.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/digesters/ContingencyDigester.py` & `sound_scape_explorer-13.2.1/processing/digesters/ContingencyDigester.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/digesters/Digester.py` & `sound_scape_explorer-13.2.1/processing/digesters/Digester.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/digesters/DistanceDigester.py` & `sound_scape_explorer-13.2.1/processing/digesters/DistanceDigester.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/digesters/MeanSpreadingDigester.py` & `sound_scape_explorer-13.2.1/processing/digesters/MeanSpreadingDigester.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/digesters/OverlapDigester.py` & `sound_scape_explorer-13.2.1/processing/digesters/OverlapDigester.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/digesters/SilhouetteDigester.py` & `sound_scape_explorer-13.2.1/processing/digesters/SilhouetteDigester.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/extractors/AcousticDiversityIndexIndicator.py` & `sound_scape_explorer-13.2.1/processing/extractors/AcousticDiversityIndexIndicator.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/extractors/BioacousticsIndexExtractor.py` & `sound_scape_explorer-13.2.1/processing/extractors/BioacousticsIndexExtractor.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/extractors/Extractor.py` & `sound_scape_explorer-13.2.1/processing/extractors/Extractor.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/extractors/LeqMaadExtractor.py` & `sound_scape_explorer-13.2.1/processing/extractors/LeqMaadExtractor.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/extractors/SoundscapeIndexExtractor.py` & `sound_scape_explorer-13.2.1/processing/extractors/SoundscapeIndexExtractor.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/extractors/VggExtractor.py` & `sound_scape_explorer-13.2.1/processing/extractors/VggExtractor.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/lib/ENES_index.py` & `sound_scape_explorer-13.2.1/processing/lib/ENES_index.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/lib/VAE_v1.py` & `sound_scape_explorer-13.2.1/processing/lib/VAE_v1.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/lib/VGG.py` & `sound_scape_explorer-13.2.1/processing/lib/VGG.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/loaders/Loader.py` & `sound_scape_explorer-13.2.1/processing/loaders/Loader.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/loaders/SoundLoader.py` & `sound_scape_explorer-13.2.1/processing/loaders/SoundLoader.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/loaders/TorchLoader.py` & `sound_scape_explorer-13.2.1/processing/loaders/TorchLoader.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/main.py` & `sound_scape_explorer-13.2.1/processing/main.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/reducers/AbstractReducer.py` & `sound_scape_explorer-13.2.1/processing/reducers/AbstractReducer.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/reducers/PcaReducer.py` & `sound_scape_explorer-13.2.1/processing/reducers/PcaReducer.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/reducers/SparsePcaReducer.py` & `sound_scape_explorer-13.2.1/processing/reducers/SparsePcaReducer.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/reducers/UmapReducer.py` & `sound_scape_explorer-13.2.1/processing/reducers/UmapReducer.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/storage/Storage.py` & `sound_scape_explorer-13.2.1/processing/storage/Storage.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/storage/StoragePath.py` & `sound_scape_explorer-13.2.1/processing/storage/StoragePath.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/append_to_config.py` & `sound_scape_explorer-13.2.1/processing/utils/append_to_config.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/ask_band.py` & `sound_scape_explorer-13.2.1/processing/utils/ask_band.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/ask_csv_path.py` & `sound_scape_explorer-13.2.1/processing/utils/ask_csv_path.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/ask_integration.py` & `sound_scape_explorer-13.2.1/processing/utils/ask_integration.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/ask_menu.py` & `sound_scape_explorer-13.2.1/processing/utils/ask_menu.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/ask_npy_path.py` & `sound_scape_explorer-13.2.1/processing/utils/ask_npy_path.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/build_aggregated_reduceables.py` & `sound_scape_explorer-13.2.1/processing/utils/build_aggregated_reduceables.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/build_reducers.py` & `sound_scape_explorer-13.2.1/processing/utils/build_reducers.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/convert_date_to_timestamp.py` & `sound_scape_explorer-13.2.1/processing/utils/convert_date_to_timestamp.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/create_timelines.py` & `sound_scape_explorer-13.2.1/processing/utils/create_timelines.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/extract_config_from_storage.py` & `sound_scape_explorer-13.2.1/processing/utils/extract_config_from_storage.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/filter_features_by_label_and_time.py` & `sound_scape_explorer-13.2.1/processing/utils/filter_features_by_label_and_time.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/is_within_interval.py` & `sound_scape_explorer-13.2.1/processing/utils/is_within_interval.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/pack_trajectories.py` & `sound_scape_explorer-13.2.1/processing/utils/pack_trajectories.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/print_action.py` & `sound_scape_explorer-13.2.1/processing/utils/print_action.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/print_aggregated_reduceables.py` & `sound_scape_explorer-13.2.1/processing/utils/print_aggregated_reduceables.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/print_autoclusters.py` & `sound_scape_explorer-13.2.1/processing/utils/print_autoclusters.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/print_digesters.py` & `sound_scape_explorer-13.2.1/processing/utils/print_digesters.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/print_extractors.py` & `sound_scape_explorer-13.2.1/processing/utils/print_extractors.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/print_file_indexes_by_site.py` & `sound_scape_explorer-13.2.1/processing/utils/print_file_indexes_by_site.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/print_labels.py` & `sound_scape_explorer-13.2.1/processing/utils/print_labels.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/print_packed_trajectories.py` & `sound_scape_explorer-13.2.1/processing/utils/print_packed_trajectories.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/print_reducers.py` & `sound_scape_explorer-13.2.1/processing/utils/print_reducers.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/print_timeline_progress.py` & `sound_scape_explorer-13.2.1/processing/utils/print_timeline_progress.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/print_trajectories.py` & `sound_scape_explorer-13.2.1/processing/utils/print_trajectories.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/read_files_durations.py` & `sound_scape_explorer-13.2.1/processing/utils/read_files_durations.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/read_trajectory_path_and_relative_timestamps.py` & `sound_scape_explorer-13.2.1/processing/utils/read_trajectory_path_and_relative_timestamps.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/split_array_by_length.py` & `sound_scape_explorer-13.2.1/processing/utils/split_array_by_length.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/validate_aggregated.py` & `sound_scape_explorer-13.2.1/processing/utils/validate_aggregated.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/validate_autoclustered.py` & `sound_scape_explorer-13.2.1/processing/utils/validate_autoclustered.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/validate_autoclusters.py` & `sound_scape_explorer-13.2.1/processing/utils/validate_autoclusters.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/validate_computation_umap.py` & `sound_scape_explorer-13.2.1/processing/utils/validate_computation_umap.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/validate_configuration.py` & `sound_scape_explorer-13.2.1/processing/utils/validate_configuration.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/validate_configuration_with_config.py` & `sound_scape_explorer-13.2.1/processing/utils/validate_configuration_with_config.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/validate_digesters.py` & `sound_scape_explorer-13.2.1/processing/utils/validate_digesters.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/validate_mean_distances_matrix.py` & `sound_scape_explorer-13.2.1/processing/utils/validate_mean_distances_matrix.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/validate_mean_distances_matrix_with_config.py` & `sound_scape_explorer-13.2.1/processing/utils/validate_mean_distances_matrix_with_config.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/validate_reduced.py` & `sound_scape_explorer-13.2.1/processing/utils/validate_reduced.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/validate_trajectory_labels.py` & `sound_scape_explorer-13.2.1/processing/utils/validate_trajectory_labels.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/walk_directory.py` & `sound_scape_explorer-13.2.1/processing/utils/walk_directory.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/processing/utils/wrap_menu_choice_with_state.py` & `sound_scape_explorer-13.2.1/processing/utils/wrap_menu_choice_with_state.py`

 * *Files identical despite different names*

### Comparing `sound_scape_explorer-13.2.0/pyproject.toml` & `sound_scape_explorer-13.2.1/pyproject.toml`
...
### Comparing `sound_scape_explorer-13.2.0/sound_scape_explorer.egg-info/PKG-INFO` & `sound_scape_explorer-13.2.1/sound_scape_explorer.egg-info/PKG-INFO`
...
### Comparing `sound_scape_explorer-13.2.0/sound_scape_explorer.egg-info/SOURCES.txt` & `sound_scape_explorer-13.2.1/sound_scape_explorer.egg-info/SOURCES.txt`
