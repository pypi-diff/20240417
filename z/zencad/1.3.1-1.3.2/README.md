# Comparing `tmp/zencad-1.3.1.tar.gz` & `tmp/zencad-1.3.2.tar.gz`
...
### Comparing `zencad-1.3.1/README.md` & `zencad-1.3.2/README.md`
...
### Comparing `zencad-1.3.1/zencad/examples/1.GeomPrim/2.prim2d/ellipse.py` & `zencad-1.3.2/zencad/examples/1.GeomPrim/2.prim2d/ellipse.py`
...
### Comparing `zencad-1.3.1/zencad/geom/wire.py` & `zencad-1.3.2/zencad/geom/wire.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/geom/wire_builder.py` & `zencad-1.3.2/zencad/geom/wire_builder.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/geombase.py` & `zencad-1.3.2/zencad/geombase.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/geometry_core_installer.py` & `zencad-1.3.2/zencad/geometry_core_installer.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/gui/actions.py` & `zencad-1.3.2/zencad/gui/actions.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/gui/display.py` & `zencad-1.3.2/zencad/gui/display.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/gui/display_only.py` & `zencad-1.3.2/zencad/gui/display_only.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/gui/info_widget.py` & `zencad-1.3.2/zencad/gui/info_widget.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/gui/libinstaller.py` & `zencad-1.3.2/zencad/gui/libinstaller.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/gui/mainwindow.py` & `zencad-1.3.2/zencad/gui/mainwindow.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/gui/settingswdg.py` & `zencad-1.3.2/zencad/gui/settingswdg.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/gui/util.py` & `zencad-1.3.2/zencad/gui/util.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/gutil.py` & `zencad-1.3.2/zencad/gutil.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/industrial-robot.svg` & `zencad-1.3.2/zencad/industrial-robot.svg`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/interactive/__init__.py` & `zencad-1.3.2/zencad/interactive/__init__.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/interactive/assemble.py` & `zencad-1.3.2/zencad/interactive/assemble.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/interactive/interactive_object.py` & `zencad-1.3.2/zencad/interactive/interactive_object.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/interactive/line.py` & `zencad-1.3.2/zencad/interactive/line.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/interactive/point.py` & `zencad-1.3.2/zencad/interactive/point.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/interactive/shape.py` & `zencad-1.3.2/zencad/interactive/shape.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/internal_models/knight.py` & `zencad-1.3.2/zencad/internal_models/knight.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/lazifier.py` & `zencad-1.3.2/zencad/lazifier.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/libs/kinematic.py` & `zencad-1.3.2/zencad/libs/kinematic.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/libs/malgo.py` & `zencad-1.3.2/zencad/libs/malgo.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/libs/screw.py` & `zencad-1.3.2/zencad/libs/screw.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/opencascade_types.py` & `zencad-1.3.2/zencad/opencascade_types.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/scene.py` & `zencad-1.3.2/zencad/scene.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/settings.py` & `zencad-1.3.2/zencad/settings.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/showapi.py` & `zencad-1.3.2/zencad/showapi.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/techpriest.jpg` & `zencad-1.3.2/zencad/techpriest.jpg`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/util.py` & `zencad-1.3.2/zencad/util.py`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad/zencad_logo.png` & `zencad-1.3.2/zencad/zencad_logo.png`

 * *Files identical despite different names*

### Comparing `zencad-1.3.1/zencad.egg-info/PKG-INFO` & `zencad-1.3.2/zencad.egg-info/PKG-INFO`
...
### Comparing `zencad-1.3.1/zencad.egg-info/SOURCES.txt` & `zencad-1.3.2/zencad.egg-info/SOURCES.txt`
