# Comparing `tmp/itkdb-0.6.0.tar.gz` & `tmp/itkdb-0.6.1.tar.gz`
...
### Comparing `itkdb-0.6.0/docs/index.md` & `itkdb-0.6.1/docs/index.md`
...
### Comparing `itkdb-0.6.0/docs/stylesheets/fonts/KFOjCnqEu92Fr1Mu51TjASc2CsTKlA.woff2` & `itkdb-0.6.1/docs/stylesheets/fonts/KFOjCnqEu92Fr1Mu51TjASc2CsTKlA.woff2`
...
### Comparing `itkdb-0.6.0/src/itkdb/models/institution.py` & `itkdb-0.6.1/src/itkdb/models/institution.py`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/src/itkdb/settings/base.py` & `itkdb-0.6.1/src/itkdb/settings/base.py`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/conftest.py` & `itkdb-0.6.1/tests/conftest.py`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/test_cli.py` & `itkdb-0.6.1/tests/test_cli.py`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/test_client.py` & `itkdb-0.6.1/tests/test_client.py`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/test_image.py` & `itkdb-0.6.1/tests/test_image.py`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/test_response.py` & `itkdb-0.6.1/tests/test_response.py`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/test_scripts.py` & `itkdb-0.6.1/tests/test_scripts.py`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/test_session.py` & `itkdb-0.6.1/tests/test_session.py`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/test_user.py` & `itkdb-0.6.1/tests/test_user.py`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/test_utils.py` & `itkdb-0.6.1/tests/test_utils.py`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/test_attachments.py` & `itkdb-0.6.1/tests/integration/test_attachments.py`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/test_binaryData.py` & `itkdb-0.6.1/tests/integration/test_binaryData.py`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/test_cache.py` & `itkdb-0.6.1/tests/integration/test_cache.py`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/test_components.py` & `itkdb-0.6.1/tests/integration/test_components.py`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/test_institution.py` & `itkdb-0.6.1/tests/integration/test_institution.py`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/test_session.py` & `itkdb-0.6.1/tests/integration/test_session.py`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/test_shipments.py` & `itkdb-0.6.1/tests/integration/test_shipments.py`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/test_summary.py` & `itkdb-0.6.1/tests/integration/test_summary.py`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/test_testproperties.py` & `itkdb-0.6.1/tests/integration/test_testproperties.py`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/test_tests.py` & `itkdb-0.6.1/tests/integration/test_tests.py`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/test_user.py` & `itkdb-0.6.1/tests/integration/test_user.py`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/test_warning.py` & `itkdb-0.6.1/tests/integration/test_warning.py`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_attachments.test_add_attachment.json` & `itkdb-0.6.1/tests/integration/cassettes/test_attachments.test_add_attachment.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_attachments.test_list_all_attachments.json` & `itkdb-0.6.1/tests/integration/cassettes/test_attachments.test_list_all_attachments.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_binaryData.test_get_empty_file.json` & `itkdb-0.6.1/tests/integration/cassettes/test_binaryData.test_get_empty_file.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_binaryData.test_get_image.json` & `itkdb-0.6.1/tests/integration/cassettes/test_binaryData.test_get_image.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_binaryData.test_get_image_model_eos.json` & `itkdb-0.6.1/tests/integration/cassettes/test_binaryData.test_get_image_model_eos.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_binaryData.test_get_json.json` & `itkdb-0.6.1/tests/integration/cassettes/test_binaryData.test_get_json.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_binaryData.test_get_plainText.json` & `itkdb-0.6.1/tests/integration/cassettes/test_binaryData.test_get_plainText.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_binaryData.test_get_zipfile.json` & `itkdb-0.6.1/tests/integration/cassettes/test_binaryData.test_get_zipfile.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_binaryData.test_issue4.json` & `itkdb-0.6.1/tests/integration/cassettes/test_binaryData.test_issue4.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_components.test_add_comment.json` & `itkdb-0.6.1/tests/integration/cassettes/test_components.test_add_comment.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_components.test_create_attachment_image_eos.json` & `itkdb-0.6.1/tests/integration/cassettes/test_components.test_create_attachment_image_eos.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_components.test_delete_attachment_image_eos.json` & `itkdb-0.6.1/tests/integration/cassettes/test_components.test_delete_attachment_image_eos.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_components.test_get.json` & `itkdb-0.6.1/tests/integration/cassettes/test_components.test_get.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_components.test_get_component_bulk.json` & `itkdb-0.6.1/tests/integration/cassettes/test_components.test_get_component_bulk.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_components.test_get_component_info_code.json` & `itkdb-0.6.1/tests/integration/cassettes/test_components.test_get_component_info_code.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_components.test_get_component_info_serial.json` & `itkdb-0.6.1/tests/integration/cassettes/test_components.test_get_component_info_serial.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_components.test_list_components_componentTypev1.json` & `itkdb-0.6.1/tests/integration/cassettes/test_components.test_list_components_componentTypev1.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_components.test_list_components_componentTypev2.json` & `itkdb-0.6.1/tests/integration/cassettes/test_components.test_list_components_componentTypev2.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_components.test_list_componentsv1.json` & `itkdb-0.6.1/tests/integration/cassettes/test_components.test_list_componentsv1.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_components.test_list_componentsv2.json` & `itkdb-0.6.1/tests/integration/cassettes/test_components.test_list_componentsv2.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_institution.test_get.json` & `itkdb-0.6.1/tests/integration/cassettes/test_institution.test_get.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_institution.test_pagination.json` & `itkdb-0.6.1/tests/integration/cassettes/test_institution.test_pagination.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_projects.test_list_projects.json` & `itkdb-0.6.1/tests/integration/cassettes/test_projects.test_list_projects.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_scripts.test_getInventory.listComponentTypes.json` & `itkdb-0.6.1/tests/integration/cassettes/test_scripts.test_getInventory.listComponentTypes.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_scripts.test_getInventory.listInstitutions.json` & `itkdb-0.6.1/tests/integration/cassettes/test_scripts.test_getInventory.listInstitutions.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_scripts.test_getInventory.listInventory.json` & `itkdb-0.6.1/tests/integration/cassettes/test_scripts.test_getInventory.listInventory.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_session.test_fake_route.json` & `itkdb-0.6.1/tests/integration/cassettes/test_session.test_fake_route.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_session.test_invalid_project.json` & `itkdb-0.6.1/tests/integration/cassettes/test_session.test_invalid_project.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_session.test_missing_required.json` & `itkdb-0.6.1/tests/integration/cassettes/test_session.test_missing_required.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_session.test_no_bearer.json` & `itkdb-0.6.1/tests/integration/cassettes/test_session.test_no_bearer.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_shipments.test_create_attachment_image_eos.json` & `itkdb-0.6.1/tests/integration/cassettes/test_shipments.test_create_attachment_image_eos.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_stats.test_get.json` & `itkdb-0.6.1/tests/integration/cassettes/test_stats.test_get.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_summary.test_get_summary.json` & `itkdb-0.6.1/tests/integration/cassettes/test_summary.test_get_summary.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_testproperties.test_delete_test_property.json` & `itkdb-0.6.1/tests/integration/cassettes/test_testproperties.test_delete_test_property.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_tests.test_create_attachment_image_eos.json` & `itkdb-0.6.1/tests/integration/cassettes/test_tests.test_create_attachment_image_eos.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_tests.test_list_test_types.json` & `itkdb-0.6.1/tests/integration/cassettes/test_tests.test_list_test_types.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_user.test_user_anonymous_login.json` & `itkdb-0.6.1/tests/integration/cassettes/test_user.test_user_anonymous_login.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_user.test_user_bad_login.json` & `itkdb-0.6.1/tests/integration/cassettes/test_user.test_user_bad_login.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_user.test_user_good_login.json` & `itkdb-0.6.1/tests/integration/cassettes/test_user.test_user_good_login.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/tests/integration/cassettes/test_warnings.test_get_component.json` & `itkdb-0.6.1/tests/integration/cassettes/test_warnings.test_get_component.json`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/.gitignore` & `itkdb-0.6.1/.gitignore`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/COPYING` & `itkdb-0.6.1/COPYING`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/LICENSE` & `itkdb-0.6.1/LICENSE`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/README.md` & `itkdb-0.6.1/README.md`
...
### Comparing `itkdb-0.6.0/pyproject.toml` & `itkdb-0.6.1/pyproject.toml`

 * *Files identical despite different names*

### Comparing `itkdb-0.6.0/PKG-INFO` & `itkdb-0.6.1/PKG-INFO`
