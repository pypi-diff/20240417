# Comparing `tmp/project-utils-django-1.0.2.tar.gz` & `tmp/project-utils-django-1.0.3.tar.gz`
...
### Comparing `project-utils-django-1.0.2/PKG-INFO` & `project-utils-django-1.0.3/PKG-INFO`
