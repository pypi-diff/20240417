# Comparing `tmp/gamspy_copt-46.4.0-py3-none-win_amd64.whl.zip` & `tmp/gamspy_copt-46.4.1-py3-none-win_amd64.whl.zip`
...
+   1804b72b7:	push   $0x5c656d6f
    ...
    1804b72d2:	outsl  %ds:(%rsi),(%dx)
    1804b72d3:	jo     0x1804b733a
```
