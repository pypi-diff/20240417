# Comparing `tmp/autogluon-1.1.0b20240415.tar.gz` & `tmp/autogluon-1.1.0b20240416.tar.gz`
...
## Comparing `autogluon-1.1.0b20240415.tar` & `autogluon-1.1.0b20240416.tar`
...
### Comparing `autogluon-1.1.0b20240415/PKG-INFO` & `autogluon-1.1.0b20240416/PKG-INFO`
...
### Comparing `autogluon-1.1.0b20240415/setup.py` & `autogluon-1.1.0b20240416/setup.py`

 * *Files identical despite different names*

### Comparing `autogluon-1.1.0b20240415/src/autogluon.egg-info/PKG-INFO` & `autogluon-1.1.0b20240416/src/autogluon.egg-info/PKG-INFO`
