# Comparing `tmp/audio_toolkit-0.7.0.tar.gz` & `tmp/audio_toolkit-0.8.0.tar.gz`
...
## Comparing `audio_toolkit-0.7.0.tar` & `audio_toolkit-0.8.0.tar`
...
### Comparing `audio_toolkit-0.7.0/LICENSE` & `audio_toolkit-0.8.0/LICENSE`

 * *Files identical despite different names*

### Comparing `audio_toolkit-0.7.0/audio_toolkit/audio_stats.py` & `audio_toolkit-0.8.0/audio_toolkit/audio_stats.py`

 * *Files identical despite different names*

### Comparing `audio_toolkit-0.7.0/setup.py` & `audio_toolkit-0.8.0/setup.py`
