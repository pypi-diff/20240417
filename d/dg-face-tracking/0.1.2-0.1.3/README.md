# Comparing `tmp/dg_face_tracking-0.1.2-py3-none-any.whl.zip` & `tmp/dg_face_tracking-0.1.3-py3-none-any.whl.zip`
...
@@ -90,14 +90,23 @@
 ...
 Filename: dg_face_tracking/Database/__init__.py
 Comment: 
 
 Filename: dg_face_tracking/Database/vectstore.py
 Comment: 
 
+Filename: dg_face_tracking/Face2ID/__init__.py
+Comment: 
+
+Filename: dg_face_tracking/Face2ID/face2id.py
+Comment: 
+
+Filename: dg_face_tracking/Face2ID/face2id_proc.py
+Comment: 
+
 Filename: dg_face_tracking/Frontend/DataFaceDoc.py
 Comment: 
 
 Filename: dg_face_tracking/Frontend/DataFaceFrontend.py
 Comment: 
 
 Filename: dg_face_tracking/Frontend/DataFaceView.py
@@ -186,23 +195,23 @@
...
## Comparing `dg_face_tracking-0.1.2.dist-info/METADATA` & `dg_face_tracking-0.1.3.dist-info/METADATA`
...
## Comparing `dg_face_tracking-0.1.2.dist-info/RECORD` & `dg_face_tracking-0.1.3.dist-info/RECORD`
