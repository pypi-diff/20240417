# Comparing `tmp/ll-la-0.29.0.tar.gz` & `tmp/ll-la-0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "ll-la-0.29.0.tar", last modified: Wed Apr 17 16:31:09 2024, max compression
+gzip compressed data, was "dist/ll-la-0.9.tar", last modified: Wed Jun 26 14:36:04 2019, max compression
```

## Comparing `ll-la-0.29.0.tar` & `ll-la-0.9.tar`

### file list

```diff
@@ -1,53 +1,20 @@
-drwxr-xr-x   0 walter     (501) staff       (20)        0 2024-04-17 16:31:09.335458 ll-la-0.29.0/
--rw-r--r--   0 walter     (501) staff       (20)     1140 2020-02-18 11:28:58.000000 ll-la-0.29.0/LICENSE.txt
--rw-r--r--   0 walter     (501) staff       (20)     1364 2024-04-17 16:31:09.335646 ll-la-0.29.0/PKG-INFO
--rw-r--r--   0 walter     (501) staff       (20)      514 2021-12-08 12:05:50.000000 ll-la-0.29.0/README.rst
--rw-r--r--   0 walter     (501) staff       (20)       92 2024-04-17 16:31:09.336037 ll-la-0.29.0/setup.cfg
--rw-r--r--   0 walter     (501) staff       (20)     2512 2024-04-17 16:30:46.000000 ll-la-0.29.0/setup.py
-drwxr-xr-x   0 walter     (501) staff       (20)        0 2024-04-17 16:31:09.327064 ll-la-0.29.0/src/
-drwxr-xr-x   0 walter     (501) staff       (20)        0 2024-04-17 16:31:09.326984 ll-la-0.29.0/src/ll/
-drwxr-xr-x   0 walter     (501) staff       (20)        0 2024-04-17 16:31:09.328484 ll-la-0.29.0/src/ll/la/
--rw-r--r--   0 walter     (501) staff       (20)   274329 2024-04-17 16:30:46.000000 ll-la-0.29.0/src/ll/la/__init__.py
--rw-r--r--   0 walter     (501) staff       (20)    63659 2024-04-16 15:03:04.000000 ll-la-0.29.0/src/ll/la/handlers.py
--rw-r--r--   0 walter     (501) staff       (20)   129600 2024-01-09 13:51:03.000000 ll-la-0.29.0/src/ll/la/vsql.py
-drwxr-xr-x   0 walter     (501) staff       (20)        0 2024-04-17 16:31:09.329437 ll-la-0.29.0/src/ll_la.egg-info/
--rw-r--r--   0 walter     (501) staff       (20)     1364 2024-04-17 16:31:09.000000 ll-la-0.29.0/src/ll_la.egg-info/PKG-INFO
--rw-r--r--   0 walter     (501) staff       (20)     1215 2024-04-17 16:31:09.000000 ll-la-0.29.0/src/ll_la.egg-info/SOURCES.txt
--rw-r--r--   0 walter     (501) staff       (20)        1 2024-04-17 16:31:09.000000 ll-la-0.29.0/src/ll_la.egg-info/dependency_links.txt
--rw-r--r--   0 walter     (501) staff       (20)        1 2019-06-26 14:24:03.000000 ll-la-0.29.0/src/ll_la.egg-info/not-zip-safe
--rw-r--r--   0 walter     (501) staff       (20)      125 2024-04-17 16:31:09.000000 ll-la-0.29.0/src/ll_la.egg-info/requires.txt
--rw-r--r--   0 walter     (501) staff       (20)        3 2024-04-17 16:31:09.000000 ll-la-0.29.0/src/ll_la.egg-info/top_level.txt
-drwxr-xr-x   0 walter     (501) staff       (20)        0 2024-04-17 16:31:09.335305 ll-la-0.29.0/test/
--rw-r--r--   0 walter     (501) staff       (20)    98350 2024-04-16 15:03:04.000000 ll-la-0.29.0/test/test_livingapi.py
--rw-r--r--   0 walter     (501) staff       (20)    18584 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql.py
--rw-r--r--   0 walter     (501) staff       (20)     3098 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_attr.py
--rw-r--r--   0 walter     (501) staff       (20)     6771 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_binop_add.py
--rw-r--r--   0 walter     (501) staff       (20)     5019 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_binop_and.py
--rw-r--r--   0 walter     (501) staff       (20)     2524 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_binop_bitand.py
--rw-r--r--   0 walter     (501) staff       (20)     2548 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_binop_bitor.py
--rw-r--r--   0 walter     (501) staff       (20)      865 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_binop_bitxor.py
--rw-r--r--   0 walter     (501) staff       (20)     5917 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_binop_contains.py
--rw-r--r--   0 walter     (501) staff       (20)     2106 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_binop_floordiv.py
--rw-r--r--   0 walter     (501) staff       (20)     5447 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_binop_is.py
--rw-r--r--   0 walter     (501) staff       (20)     5603 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_binop_isnot.py
--rw-r--r--   0 walter     (501) staff       (20)     1935 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_binop_item.py
--rw-r--r--   0 walter     (501) staff       (20)     1912 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_binop_mod.py
--rw-r--r--   0 walter     (501) staff       (20)     7513 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_binop_mul.py
--rw-r--r--   0 walter     (501) staff       (20)     6128 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_binop_notcontains.py
--rw-r--r--   0 walter     (501) staff       (20)     5191 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_binop_or.py
--rw-r--r--   0 walter     (501) staff       (20)      774 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_binop_shiftleft.py
--rw-r--r--   0 walter     (501) staff       (20)      875 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_binop_shiftright.py
--rw-r--r--   0 walter     (501) staff       (20)     2675 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_binop_sub.py
--rw-r--r--   0 walter     (501) staff       (20)     1731 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_binop_truediv.py
--rw-r--r--   0 walter     (501) staff       (20)    20436 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_cmp_eq.py
--rw-r--r--   0 walter     (501) staff       (20)    17052 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_cmp_ge.py
--rw-r--r--   0 walter     (501) staff       (20)    16805 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_cmp_gt.py
--rw-r--r--   0 walter     (501) staff       (20)    17013 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_cmp_le.py
--rw-r--r--   0 walter     (501) staff       (20)    16765 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_cmp_lt.py
--rw-r--r--   0 walter     (501) staff       (20)    19894 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_cmp_ne.py
--rw-r--r--   0 walter     (501) staff       (20)    20706 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_func.py
--rw-r--r--   0 walter     (501) staff       (20)     3258 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_meth.py
--rw-r--r--   0 walter     (501) staff       (20)     9501 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_slice.py
--rw-r--r--   0 walter     (501) staff       (20)      679 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_unop_bitnot.py
--rw-r--r--   0 walter     (501) staff       (20)     1580 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_unop_neg.py
--rw-r--r--   0 walter     (501) staff       (20)     2520 2023-12-07 15:50:09.000000 ll-la-0.29.0/test/test_vsql_unop_not.py
...
### Comparing `ll-la-0.29.0/PKG-INFO` & `ll-la-0.9/PKG-INFO`
...
### Comparing `ll-la-0.29.0/setup.py` & `ll-la-0.9/setup.py`
...
### Comparing `ll-la-0.29.0/src/ll/la/handlers.py` & `ll-la-0.9/src/ll/la/handlers.py`
...
### Comparing `ll-la-0.29.0/src/ll_la.egg-info/PKG-INFO` & `ll-la-0.9/src/ll_la.egg-info/PKG-INFO`
