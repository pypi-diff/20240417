# Comparing `tmp/mkdocs-juvix-plugin-0.1.4.tar.gz` & `tmp/mkdocs-juvix-plugin-0.2.0.tar.gz`
...
+gzip compressed data, was "mkdocs-juvix-plugin-0.2.0.tar", last modified: Wed Apr 17 09:58:35 2024, max compression
```

## Comparing `mkdocs-juvix-plugin-0.1.4.tar` & `mkdocs-juvix-plugin-0.2.0.tar`
...
+drwxr-xr-x   0 jonaprieto   (501) staff       (20)        0 2024-04-17 09:58:35.855589 mkdocs-juvix-plugin-0.2.0/
+-rw-r--r--   0 jonaprieto   (501) staff       (20)      493 2024-04-17 09:58:35.855318 mkdocs-juvix-plugin-0.2.0/PKG-INFO
+-rw-r--r--   0 jonaprieto   (501) staff       (20)     2459 2024-04-17 09:44:23.000000 mkdocs-juvix-plugin-0.2.0/README.md
+drwxr-xr-x   0 jonaprieto   (501) staff       (20)        0 2024-04-17 09:58:35.853755 mkdocs-juvix-plugin-0.2.0/mkdocs_juvix/
+-rw-r--r--   0 jonaprieto   (501) staff       (20)        0 2023-10-30 14:15:49.000000 mkdocs-juvix-plugin-0.2.0/mkdocs_juvix/__init__.py
+-rw-r--r--   0 jonaprieto   (501) staff       (20)    18459 2024-04-17 09:43:07.000000 mkdocs-juvix-plugin-0.2.0/mkdocs_juvix/plugin.py
+-rw-r--r--   0 jonaprieto   (501) staff       (20)     3364 2024-04-17 09:42:21.000000 mkdocs-juvix-plugin-0.2.0/mkdocs_juvix/standalone.py
+-rw-r--r--   0 jonaprieto   (501) staff       (20)     2438 2024-04-17 09:46:29.000000 mkdocs-juvix-plugin-0.2.0/mkdocs_juvix/utils.py
+drwxr-xr-x   0 jonaprieto   (501) staff       (20)        0 2024-04-17 09:58:35.855001 mkdocs-juvix-plugin-0.2.0/mkdocs_juvix_plugin.egg-info/
+-rw-r--r--   0 jonaprieto   (501) staff       (20)      493 2024-04-17 09:58:35.000000 mkdocs-juvix-plugin-0.2.0/mkdocs_juvix_plugin.egg-info/PKG-INFO
+-rw-r--r--   0 jonaprieto   (501) staff       (20)      375 2024-04-17 09:58:35.000000 mkdocs-juvix-plugin-0.2.0/mkdocs_juvix_plugin.egg-info/SOURCES.txt
+-rw-r--r--   0 jonaprieto   (501) staff       (20)        1 2024-04-17 09:58:35.000000 mkdocs-juvix-plugin-0.2.0/mkdocs_juvix_plugin.egg-info/dependency_links.txt
+-rw-r--r--   0 jonaprieto   (501) staff       (20)      107 2024-04-17 09:58:35.000000 mkdocs-juvix-plugin-0.2.0/mkdocs_juvix_plugin.egg-info/entry_points.txt
+-rw-r--r--   0 jonaprieto   (501) staff       (20)       40 2024-04-17 09:58:35.000000 mkdocs-juvix-plugin-0.2.0/mkdocs_juvix_plugin.egg-info/requires.txt
+-rw-r--r--   0 jonaprieto   (501) staff       (20)       13 2024-04-17 09:58:35.000000 mkdocs-juvix-plugin-0.2.0/mkdocs_juvix_plugin.egg-info/top_level.txt
+-rw-r--r--   0 jonaprieto   (501) staff       (20)       38 2024-04-17 09:58:35.855643 mkdocs-juvix-plugin-0.2.0/setup.cfg
+-rw-r--r--   0 jonaprieto   (501) staff       (20)      827 2024-04-17 09:46:11.000000 mkdocs-juvix-plugin-0.2.0/setup.py
```

### Comparing `mkdocs-juvix-plugin-0.1.4/README.md` & `mkdocs-juvix-plugin-0.2.0/README.md`
...
### Comparing `mkdocs-juvix-plugin-0.1.4/mkdocs_juvix/standalone.py` & `mkdocs-juvix-plugin-0.2.0/mkdocs_juvix/standalone.py`
...
### Comparing `mkdocs-juvix-plugin-0.1.4/setup.py` & `mkdocs-juvix-plugin-0.2.0/setup.py`
