# Comparing `tmp/mkdocs-juvix-plugin-0.1.4.tar.gz` & `tmp/mkdocs-juvix-plugin-0.2.tar.gz`
...
## Comparing `mkdocs-juvix-plugin-0.1.4.tar` & `mkdocs-juvix-plugin-0.2.tar`
...
### Comparing `mkdocs-juvix-plugin-0.1.4/README.md` & `mkdocs-juvix-plugin-0.2/README.md`
...
### Comparing `mkdocs-juvix-plugin-0.1.4/mkdocs_juvix/standalone.py` & `mkdocs-juvix-plugin-0.2/mkdocs_juvix/standalone.py`
...
### Comparing `mkdocs-juvix-plugin-0.1.4/setup.py` & `mkdocs-juvix-plugin-0.2/setup.py`
